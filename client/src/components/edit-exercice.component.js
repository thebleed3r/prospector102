...
export default class EditPropsection extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios.get('https://glacial-shelf-37833.herokuapp.com/prospections/'+this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios.post('https://glacial-shelf-37833.herokuapp.com/prospections/update/' + this.props.match.params.id, prospection)
  ...
  render() {
    ...
    <div>
      ...
      <p className="lead p-2">Edit Prospection:</p>
      ...
      <form onSubmit={this.onSubmit}>
        ...
        <div className="form-group text-right">
          <input type="submit" value="Edit Entry" className="btn" />
        </div>
      </form>
    </div>
    )
